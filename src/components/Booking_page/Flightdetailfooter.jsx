...
const Flightdetailfooter = () => {
  const handle = () => {
    const res = localStorage.getItem("buy");
    const flight = JSON.parse(res || "{}");
    const amount =
      Number(flight?.price?.amount || 0) ||
      (+flight?.departure?.delay === 0
        ? 1200
        : Number(flight?.departure?.delay || 0) * 200);
      ...
      <div className="flightfooter">
        ...
        <div>
          <div className="inline">
            <img
              alt=""
              src="https://imgak.mmtcdn.com/flights/assets/media/dt/rta_assets/imp-info.png"
            />
          ...
          <ul>
            ...
            <li>
              COVID test requirements : Negative RT-PCR test report is not
              required for passengers travelling from other states to enter
              Telangana.
            </li>
            <li>
              Pre-registration or e-Pass requirements : Download and update
              Aarogya Setu app.
            </li>
            ...
            <li>
              The latest DGCA guidelines state that it is compulsory to wear a
              mask that covers the nose and mouth properly while at the airport
              and on the flight. Any lapse might result in de-boarding.
            </li>
            <li>
        ...
        <div>
          ...
          <ul>
            <li>
              ...
              additional charges per piece in addition to the excess baggage
              charges.
            </li>
          </ul>
        </div>
        <div>
          ...
          <ul>
            <li>
              Disclaimer: The information provided above is only for ready
              reference and convenience of customers, and may not be exhaustive.
              We strongly recommend that you check the full text of the
              guidelines issued by the State Governments before travelling.
            </li>
          </ul>
        </div>
      </div>
